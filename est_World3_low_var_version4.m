...
param_settings.init_param_guess.le_param1 = 1;
...
%%% TO DO: add inflation as  linear combination of lagged gdp and resource ratio
for t = 1:T
...
%  disp('Simulating...')
%  tic
% [sim_traj] = nonlin_sim4b(eq_sim,[],shocks,no_shocks,params,init_param_guess);
% sim_time = toc
...
% hold on
% tt=1:T;
% plot(tt,traj(149,tt),'r') %Land_Fertility
% plot(tt,traj(143,tt),'g') %food_per_capita
% plot(tt,traj(144,tt),'y') %Arable_Land
% plot(tt,traj(98,tt),'m') %land_fertility_regeneration
% plot(tt,traj(99,tt),'b') %land_fertility_degredation
% plot(tt,traj(156,tt),'black') %land_yield
% legend('Land Fertility','food per capita','Arable Land','land fertility regeneration','land fertility degredation','land yield')
% xticks(1:10/dt:T)
% xticklabels(raw_data.Date(est_start:10/dt:est_end))
% hold off
...
% hold on
% tt=1:T;
% plot(tt,traj(38,tt),'r') %persistent_pollution_generation_industry
% plot(tt,traj(46,tt),'g') %persistent_pollution_assimilation_rate
% plot(tt,traj(27,tt),'y') %persistent_pollution_generation_agriculture
% plot(tt,traj(51,tt),'m') %persistent_pollution_appearance_rate
% plot(tt,traj(121,tt),'b') %Persistent_Pollution
% plot(tt,traj(52,tt),'black') %persistent_pollution_generation_rate
% legend('persistent pollution generation industry','persistent pollution assimilation rate','persistent pollution generation agriculture','persistent pollution appearance rate','Persistent Pollution','persistent pollution generation rate')
% xticks(1:10/dt:T)
% xticklabels(raw_data.Date(est_start:10/dt:est_end))
% hold off
