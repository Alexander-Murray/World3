...
eq_var = eq_fun{1}(init_param_guess,init_vars,shift_times-t+1,zeros(n_shocks,1));
world3_jac = jacobian(eq_var,init_vars);
world3_jac_eq = Function('jacobian',{init_vars},{world3_jac});
world3_jac_eval = world3_jac_eq(init_var_vals);
world3_jac_eval = world3_jac_eval(:,1:n_var); % remove inflation vars
